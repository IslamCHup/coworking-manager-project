...
**Coworking Manager** — это backend-приложение для автоматизации процессов коворкинга, проект реализует бронирование рабочих мест и переговорных комнат, управление пользователями и ролями, тарифами и расписанием, а также бизнес-логику проверки пересечений и расчёта стоимости.
